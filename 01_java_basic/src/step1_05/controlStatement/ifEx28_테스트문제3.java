...
public class ifEx28_테스트문제3 {
	...
	public static void main(String[] args) {
		...
		else if (comFinal == 1) comFinal = comRight;	
		System.out.println();
		
		switch(comFinal) {
		case 0 : if(meFinal == 0) {System.out.println("비김"); break;}
		//가위	else if (meFinal = 1) {System.out.println("이김"); break;}
				else {System.out.println("짐"); break;}
			
		
		case 1 : if(meFinal == 1) {System.out.println("비김"); break;}
		//바위	else if (meFinal = 2) {System.out.println("이김"); break;}
				else {System.out.println("짐"); break;}
		
	
		case 2 : if (meFinal == 2) {System.out.println("비김"); break;}
		//보	else if (meFinal = 0) {System.out.println("이김"); break;}
				else {System.out.println("짐"); break;}
